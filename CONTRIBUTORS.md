...
Thank you to everyone who has contributed to the SAP-1 Computer Architecture project! This project wouldn't be possible without the dedication and collaboration of our team.
...
If you are a student or a collaborator and want to contribute:
1. Fork the repository.
2. Create your feature branch (`git checkout -b feature/AmazingFeature`).
3. Commit your changes.
4. Push to the branch.
5. Open a Pull Request and **add your name to this list**!